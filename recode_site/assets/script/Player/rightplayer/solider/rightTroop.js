...
cc.Class({
    ...
    judgeRegion() {
        ...
        this.maplocation.rightCityJudgeOthercity('troop')
    },
    restoreRegion() {
        this.maplocation.updateSoliderLocation()
        for (let i = 1; i < 9; i++) {
            cc.find(`Canvas/background/RightCity/troop/fightRegion/region${i}`).active = true
        }
    },
    ...
    onLoad() {
        ...
        cc.find(`Canvas/background/RightCity/knight`).getComponent('rightKnight').broTroop = this
        cc.find('Canvas/background/RightCity/archer').getComponent('rightArcher').broTroop = this
    },
