...
module.exports = cc.Class({
    ...
    basicclickSound:function(){
        if(this.sfx){
            this.BtnEffect = cc.loader.getRes("sound/Battle_Start_Button",cc.AudioClip)
            cc.audioEngine.playEffect(this.BtnEffect,false)
        }
    },
    //世界背景音乐
    onPlayWorldBgSound:function(){
        console.log('world music')
        cc.audioEngine.stopMusic()
        this.bgsound = cc.loader.getRes("sound/BL-BG-Piece-8-Master_1",cc.AudioClip)
