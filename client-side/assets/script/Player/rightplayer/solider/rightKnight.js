...
cc.Class({
    ...
    judgeRegion() {
        ...
        this.maplocation.rightCityJudgeOthercity('knight')
    },
    restoreRegion() {
        this.maplocation.updateSoliderLocation()
        for (let i = 1; i < 9; i++) {
            cc.find(`Canvas/background/RightCity/knight/fightRegion/region${i}`).active = true
        }
    },
    ...
    onLoad() {
        ...
        cc.find(`Canvas/background/RightCity/archer`).getComponent('rightArcher').broKnight = this
        cc.find('Canvas/background/RightCity/troop').getComponent('rightTroop').broKnight = this
    },
