...
cc.Class({
    ...
    judgeRegion() {
        ...
        this.maplocation.leftCityJudgeOthercity('troop')
    },
    restoreRegion() {
        this.maplocation.updateSoliderLocation()
        for (let i = 1; i < 9; i++) {
            cc.find(`Canvas/background/LeftCity/troop/fightRegion/region${i}`).active = true
        }
    },
    ...
    onLoad() {
        ...
        cc.find(`Canvas/background/LeftCity/knight`).getComponent('leftKnight').broTroop = this
        cc.find('Canvas/background/LeftCity/archer').getComponent('leftArcher').broTroop = this
    },
